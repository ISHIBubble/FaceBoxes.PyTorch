...
# ========================================================================================
# Test CLI command: python test.py --trained_model weights/{FILENAME} --dataset PASCAL --cpu
# ========================================================================================

parser = argparse.ArgumentParser(description='FaceBoxes with Focal Loss, CIoU Loss and Depthwise Separable Convolutions')

parser.add_argument('-m', '--trained_model', default='weights/FaceBoxes_FL_CIoU_DSConv.pth',
