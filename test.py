...
parser = argparse.ArgumentParser(description='FaceBoxes-DSConv_Hardswish')

parser.add_argument('-m', '--trained_model', default='weights/FaceBoxes_DSConv_Hardswish.pth',
