...
parser = argparse.ArgumentParser(description='FaceBoxes Inverted Residuals with Linear Bottleneck and Depthwise Seperable Convolutions')

parser.add_argument('-m', '--trained_model', default='weights/FaceBoxes_DS_IR_LB.pth',
