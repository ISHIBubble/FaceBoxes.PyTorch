...
parser = argparse.ArgumentParser(description='FaceBoxes Inverted Residuals with Linear Bottleneck')

parser.add_argument('-m', '--trained_model', default='weights/FaceBoxes_IR_LB.pth',
