...
# ========================================================================================
# Test CLI command: python test.py --trained_model weights/FaceBoxes_FL_CIoU.pth --dataset PASCAL --cpu
# ========================================================================================

parser = argparse.ArgumentParser(description='FaceBoxes with Focal Loss and CIoU loss')

parser.add_argument('-m', '--trained_model', default='weights/FaceBoxes_FL_CIoU.pth',
